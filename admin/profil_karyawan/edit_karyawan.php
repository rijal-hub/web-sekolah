...
if (isset($_GET['id'])) {
    ...
    // Query untuk mengambil data prestasi berdasarkan id
...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    if ($_FILES['foto']['error'] == 0) {
        ...
        $query = "UPDATE profil_karyawan SET nama = ?, jabatan = ?, foto = ? WHERE id = ?";
        $stmt = $conn->prepare($query);
        $stmt->bind_param("sssi", $nama, $jabatan, $foto_name, $id);
    } else {
        // Update tanpa foto jika tidak ada foto yang diupload
        $query = "UPDATE profil_karyawan SET nama = ?, jabatan = ? WHERE id = ?";
        $stmt = $conn->prepare($query);
    ...
    if ($stmt->execute()) {
        ...
        header("Location: profil_karyawan.php"); // Kembali ke halaman daftar prestasi setelah update
        exit;
    } else {
        ...
        <li class="nav-item active">
            ...
            <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                <div class="bg-white py-2 collapse-inner rounded">
                    ...
                    <a class="collapse-item active" href="../profil_karyawan/profil_karyawan.php">Profil Karyawan</a>
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <!-- Page Heading -->
                    <h1 class="h3 mb-2 text-gray-800 font-weight-bold">Tambah Karyawan</h1>
                    <p class="mb-4">Halaman ini digunakan untuk menambah data profil karyawan.</p>
                    ...
                    <div class="card shadow mb-4">
                        ...
                        <div class="card-body">
                        <form action="edit_karyawan.php?id=<?php echo $karyawan['id']; ?>" method="POST" enctype="multipart/form-data">
                            <div>
                                <label for="nama">Nama Karyawan:</label>
                                <input type="text" class="form-control" name="nama" id="nama" value="<?php echo $karyawan['nama']; ?>" required>
                            </div><br>
                            <div>
                                <label for="foto">Foto:</label>
                                <input type="file" class="form-control" name="foto" id="foto">
                                <p>Foto saat ini:<br> <img src="uploads/<?php echo $karyawan['foto']; ?>" width="200"></p>
                            </div>
                            <div>
                                <label for="jabatan">Jabatan:</label>
                                <input type="text" class="form-control" name="jabatan" id="jabatan" value="<?php echo $karyawan['jabatan']; ?>" required>
                            </div><br>
                            <div>
                                <button type="submit" class="btn btn-primary" >Update Profil Karyawan</button>
                            </div>
                        </form>
                        </div>
                    </div>
