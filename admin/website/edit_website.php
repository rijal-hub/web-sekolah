...
if (isset($_GET['id'])) {
    ...
    $query = "SELECT * FROM website WHERE id = ?";
...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    $query_update = "UPDATE website SET nama_web = ?, link = ? WHERE id = ?";
    $stmt = $conn->prepare($query_update);
    $stmt->bind_param("ssi", $nama_web, $link, $id);

    // Eksekusi query update
    if ($stmt->execute()) {
        echo "Website berhasil diperbarui!";
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="card shadow mb-4">
                        ...
                        <div class="card-body">
                        <form action="edit_website.php?id=<?php echo $website['id']; ?>" method="POST" enctype="multipart/form-data">
                            <div>
                                <label for="nama_web">Nama Website:</label>
                                <input type="text" class="form-control" name="nama_web" id="nama_web" value="<?php echo $website['nama_web']; ?>" required>
                            </div>                            
                            <div>
                                <label for="link">Link:</label>
                                <textarea name="link" class="form-control" id="link" required><?php echo $website['link']; ?></textarea>
                            </div>
                            <div>
