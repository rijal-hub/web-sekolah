...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    // If everything is ok, try to upload file
        ...
        if (move_uploaded_file($_FILES["foto"]["tmp_name"], $target_file)) {
            ...
            $query = "INSERT INTO kegiatan_sekolah (nama_kegiatan, foto, deskripsi) VALUES ('$nama_kegiatan', '" . basename($_FILES["foto"]["name"]) . "', '$deskripsi')";
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <!-- Page Heading -->
                    <h1 class="h3 mb-2 text-gray-800 font-weight-bold">Tambah kegiatan</h1>
                    <p class="mb-4">Halaman ini digunakan untuk menambah data kegiatan sekolah.</p>
