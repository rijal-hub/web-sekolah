...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    if ($stmt->execute()) {
        echo "Prestasi berhasil diperbarui!";
        header("Location: prestasi_sekolah.php"); // Kembali ke halaman daftar prestasi setelah update
        exit;
    } else {
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <!-- Page Heading -->
                    <h1 class="h3 mb-2 text-gray-800 font-weight-bold">Tambah Prestasi</h1>
                    <p class="mb-4">Halaman ini digunakan untuk menambah data prestasi sekolah.</p>
                    ...
                    <div class="card shadow mb-4">
                        ...
                        <div class="card-body">
                        <form action="edit_prestasi.php?id=<?php echo $prestasi['id']; ?>" method="POST" enctype="multipart/form-data">
                            <div>
                            ...
                            <div>
                                ...
                                <p>Foto saat ini:<br> <img src="uploads/<?php echo $prestasi['foto']; ?>" width="200"></p>
                            </div>
                            <div>
                                <label for="deskripsi">Deskripsi:</label>
                                <textarea name="deskripsi" class="form-control" id="deskripsi" required><?php echo $prestasi['deskripsi']; ?></textarea>
                            </div>
                            <div>
