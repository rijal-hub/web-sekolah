...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    // If everything is ok, try to upload file
        ...
        if (move_uploaded_file($_FILES["foto"]["tmp_name"], $target_file)) {
            ...
            $query = "INSERT INTO sarana_prasarana  (nama, foto, deskripsi) VALUES ('$nama', '" . basename($_FILES["foto"]["name"]) . "', '$deskripsi')";
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <!-- Page Heading -->
                    <h1 class="h3 mb-2 text-gray-800 font-weight-bold">Tambah Sarana Prasarana</h1>
                    <p class="mb-4">Halaman ini digunakan untuk menambah data sarana prasarana sekolah.</p>

                    <!-- Konten-->
                    <div class="card shadow mb-4">
                        <div class="card-header py-3">
                            <h6 class="m-0 font-weight-bold text-primary">Form Tambah Sarana Prasarana</h6>
                        </div>
                        <div class="card-body">
                            <form method="POST" enctype="multipart/form-data">
                                ...
                                <button type="submit" class="btn btn-primary">Tambah Sarana Prasarana</button>
                            </form>
                        </div>
                    </div>
                </div>
